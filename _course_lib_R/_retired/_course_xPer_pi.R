# source("../_course_lib_R/_course_xPer_pi.R") ; xPer_pi_BPP()
...
xPer_pi_BPP = function(signifDigits=1:15)
{
                          ...
                          cntProbeLmt=1000, needleRatio=1.0, signifDigits=2:4)
{
  ...
  header = c(
    ...
    paste("# cntProbeLmt  =", cntProbeLmt),
    paste("# needleRatio  =", needleRatio),
    paste("# signifDigits =", signifDigits), 
    "#"
  )
  fileAsymPath = paste(getwd(), "/", fileAsym, sep="")
